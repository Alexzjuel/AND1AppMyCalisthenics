package com.e.and1appmycalisthenics.ExerciseLibrary;
...
//        ConstraintLayout  constraintLayout = (ConstraintLayout) findViewById(R.id.activity_exercise_library);
    ...
    private YouTubePlayer.PlaybackEventListener playbackEventListener = new YouTubePlayer.PlaybackEventListener() {
        ...
        public void onPlaying() {
            Toast.makeText(com.e.and1appmycalisthenics.ExerciseLibrary.ExerciseLibraryActivity.this, "Video is Playing", Toast.LENGTH_LONG).show();
        }

        @Override
        public void onPaused() {
            Toast.makeText(com.e.and1appmycalisthenics.ExerciseLibrary.ExerciseLibraryActivity.this, "Video Paused", Toast.LENGTH_LONG).show();
        }

        @Override
        public void onStopped() {
            Toast.makeText(com.e.and1appmycalisthenics.ExerciseLibrary.ExerciseLibraryActivity.this, "Video Stopped", Toast.LENGTH_LONG).show();
        }
    ...
    private YouTubePlayer.PlayerStateChangeListener playerStateChangeListener = new YouTubePlayer.PlayerStateChangeListener() {
        ...
        public void onAdStarted() {
            Toast.makeText(com.e.and1appmycalisthenics.ExerciseLibrary.ExerciseLibraryActivity.this, "Click Ad", Toast.LENGTH_LONG).show();
        }

        @Override
        public void onVideoStarted() {
            Toast.makeText(com.e.and1appmycalisthenics.ExerciseLibrary.ExerciseLibraryActivity.this, "Video Started", Toast.LENGTH_LONG).show();
        }

        @Override
        public void onVideoEnded() {
            Toast.makeText(com.e.and1appmycalisthenics.ExerciseLibrary.ExerciseLibraryActivity.this, "Video Finished", Toast.LENGTH_LONG).show();
        }
